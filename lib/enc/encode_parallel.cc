...
#include <impl/enc/bit_cost.h>
#include <impl/enc/block_splitter.h>
#include <impl/enc/brotli_bit_stream.h>
#include <impl/enc/cluster.h>
#include <impl/enc/context.h>
#include <impl/enc/metablock.h>
#include <impl/enc/transform.h>
...
bool WriteMetaBlockParallel(const BrotliParams& params,
  ...
  CreateBackwardReferences(
      ...
      hashers,
      hash_type,
      params.enable_relative,
      params.enable_dictionary,
      dist_cache,
      &last_insert_len,
      commands,
      &num_commands,
